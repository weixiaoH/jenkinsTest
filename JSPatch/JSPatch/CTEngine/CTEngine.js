...
;(function() {
  ...
  var _formatXXXOCToJS = function(obj) {
    ...
    if (obj instanceof Function) {
        return function() {
            ...
            var formatedArgs = _OC_XXXformatJSToOC(args)
        ...
        return _OC_XXXformatOCToJS(obj.apply(obj, formatedArgs))
      }
    }
    if (obj instanceof Object) {
      var ret = {}
      for (var key in obj) {
        ret[key] = _formatXXXOCToJS(obj[key])
      }
      return ret
    }
    return obj
  ...
  var _methodFunc = function(instance, clsName, methodName, args, isSuper, isPerformSelector) {
    ...
    var ret = instance ? _OC_XXXcallI(instance, selectorName, args, isSuper):
                         _OC_XXXcallC(clsName, selectorName, args)
    return _formatXXXOCToJS(ret)
  }
  ...
  var _customMethods = {
    __c: function(methodName) {
      ...
      if (slf.__isSuper && slf.__clsName) {
          slf.__clsName = _OC_XXXsuperClsName(slf.__obj.__realClsName ? slf.__obj.__realClsName: slf.__clsName);
      }
    ...
    performSelectorInOC: function() {
      var slf = this
      var args = Array.prototype.slice.call(arguments)
      return {__isXXXPerformInOC:1, obj:slf.__obj, clsName:slf.__clsName, sel: args[0], args: args[1], cb: args[2]}
    },
    ...
    for (var methodName in methods) {
      ...
      (function(){
        ...
        newMethods[methodName] = [originMethod.length, function() {
          try {
            var args = _formatXXXOCToJS(Array.prototype.slice.call(arguments))
            ...
            _OC_XXXcatch(e.message, e.stack)
          }
        }]
      })()
    }
  ...
  var _propertiesGetFun = function(name){
    return function(){
      var slf = this;
      if (!slf.__ocProps) {
        var props = _OC_XXXgetCustomProps(slf.__obj)
        if (!props) {
          props = {}
          _OC_XXXsetCustomProps(slf.__obj, props)
        }
        slf.__ocProps = props;
      }
  ...
  global.defineClass = function(declaration, properties, instMethods, clsMethods) {
    ...
    var ret = _OC_XXXdefineClass(declaration, newInstMethods, newClsMethods)
  ...
  global.defineProtocol = function(declaration, instProtos , clsProtos) {
      var ret = _OC_XXXdefineProtocol(declaration, instProtos,clsProtos);
      return ret
  }
  ...
  global.block = function(args, cb) {
    ...
    var callback = function() {
      var args = Array.prototype.slice.call(arguments)
      global.self = slf
      return cb.apply(that, _formatXXXOCToJS(args))
    }
    var ret = {args: args, cb: callback, argCount: cb.length, __isXXXBlock: 1}
  ...
  if (global.console) {
    ...
    global.console.log = function() {
      global._OC_XXXlog.apply(global, arguments);
      if (jsLogger) {
  ...
  global.YES = 1
  global.NO = 0
  global.nsnull = _OC_XXXnull
  global._formatXXXOCToJS = _formatXXXOCToJS
